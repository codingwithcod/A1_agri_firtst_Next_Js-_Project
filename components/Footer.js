...
const Footer = () => {
  ...
  <div className="container px-5 py-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    <Link href='/'>
      ...
      <p className="mt-2 text-sm text-gray-500">welcome to the agri world by A1Agriculture</p>
    </div>
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-6">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Post</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Quiz</a>
          </li>
          <li>
